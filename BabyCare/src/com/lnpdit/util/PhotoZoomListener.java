...
public class PhotoZoomListener implements View.OnTouchListener {
	...
	private PhotoZoomState mState;

	private float mX;
	private float mY;
	private float mGap;

	public void setZoomState(PhotoZoomState state) {
		mState = state;
	}
