...
public class ImageAndChuQinListAdapter extends ArrayAdapter<ImageAndText> {

	private ListView listView;
	private AsyncImageLoader asyncImageLoader;
	Context mContext;

	public ImageAndChuQinListAdapter(Activity activity,
	...
	class newsAdapterListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.putExtra("PIC", MainActivity.IP + "/manage/pic/" +Pic);
